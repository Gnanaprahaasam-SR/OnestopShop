        ...
        <>
            <div key={key} style={{ background: "var(--accent-color)" }}>
                <div className='p-3 position-relative'>
                    <img src={backgroundImage} alt={title} width="100%" style={{
                        height:
                            "550px"
                    }} />
                    <h2 className='category-hero-title' style={{ animation: "catogory-title-popUp 0.7s forwards", zIndex: 4 }}>SHOP {title}</h2>
