...
const WishList = () => {
    ...
    const handleIncrease = () => {
        if (product > 0) {
           const increaseProduct = product + 1;
           setProduct(increaseProduct);
        }
    ...
    const handleDecrease = () => {
        if (product > 0) {
            const  decreaseProduct = product - 1;
            setProduct(decreaseProduct);
        }
    ...
    return (
        <div className="mb-5">
            <div className="container ">
                <span className="icon mb-4">Home &#10148; {"WishList"}</span>
                <h5 className="page_title">WishList</h5>
                    ...
                    <div className="col-md-8 col-12 ">
                        <div className="row border rounded-3 m-1 py-2 ">
                            ...
                            <div className=" col-sm-3 col-md-3 mb-2">
                                ...
                                <select name="Quantity" id="" className="form-select form-select-sm w-auto d-none d-sm-block" onChange={(e)=>setProduct(e.target.value)}>
                            ...
                            <div className="clearfix mb-2">
                                <div class="input-group flex-nowrap w-50  d-sm-none float-start ">
                                    <button class="btn border" type="button" onClick={handleDecrease} >-</button>
                                    <input type="text" class="form-control text-center" value={product} />
                                    <button class="btn border" type="button" onClick={handleIncrease} >+</button>
                                </div>
